...
Test file #0 for run_different_designs().

The correct answers are stored in test_run_different_designs_ref_data_0.npz
"""
...
ref_data = np.load('test_run_different_designs_ref_data_0.npz')
sway_array_expected = ref_data['sway_BK'] # (5,10)
