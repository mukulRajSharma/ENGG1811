...
Test file #1 for run_different_designs().

The correct answers are stored in test_run_different_designs_ref_data_1.npz
"""
...
C = 0 # 16      # /m/s , 
Omega_0 = 6.47 # rad/s, corresponding to 1.03Hz 
dis0 = 0.1
vel0 = 0
...
ref_data = np.load('test_run_different_designs_ref_data_1.npz')
